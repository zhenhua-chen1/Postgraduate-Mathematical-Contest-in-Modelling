...
dataA_Flight=readtable('机组排班Data A-Flight.xlsx');
...
DptrTime1 = dataA_Flight{:,12};
DptrStn1 = dataA_Flight{:,4};
ArrvTime1 = dataA_Flight{:,16};
ArrvStn1 = dataA_Flight{:,7};
DptrDay = dataA_Flight{:,10};
ArrvDay = dataA_Flight{:,14};
% VarName12 =dataA_Flight{:,6};
% VarName13 = dataA_Flight{:,7};
% VarName15 = dataA_Flight{:,9};
% VarName16 = dataA_Flight{:,10};
FltNum2 = dataA_Flight{:,17};
